      ...
      <View style={styles.navContainer}>
        ...
        <TouchableOpacity onPress={() => goToPage('/Search')}>
          <Icon
            color="#ce4500"
            size={IconSize}
            source={path.startsWith('/Search') ? 'magnify' : 'magnify'}
          />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => goToPage('/AddPost')}>
          <Icon
            color="#ce4500"
            size={IconSize}
            source={path.startsWith('/AddPost') ? 'sticker-plus' : 'sticker-plus-outline'}
          />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => goToPage('/watch')}>
          <Icon
            color="#ce4500"
            size={IconSize}
            source={path.startsWith('/watch') ? 'movie' : 'movie-outline'}
          />
        </TouchableOpacity>
